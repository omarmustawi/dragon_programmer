  ...
  return (
    <>
      ...
      <Routes>
        ...
        {/* <Route path="/user/:id" element={<CoursePage />} />  HERR WHEN I AM IN PORTFOLIO AND THEN I MOVE TO A COURSE PAGE */}
        <Route path="/courses" element={<Courses />} />
        <Route path="/courses/:id" element={<CoursePage />} />  {/* HERR WHEN I AM IN COURSES LIST PAGE  AND THEN I MOVE TO A COURSE PAGE */}
